...
type MyTimeTableProps = NativeStackScreenProps<RootStackParamList, 'MyTimeTable'>;

const MyTimeTable = ({route}: MyTimeTableProps) => {
    ...
    return (
      <View
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.push('MyTimeTableTermWise', {code: item.code, name: item.name, levelId: item.id})}>
